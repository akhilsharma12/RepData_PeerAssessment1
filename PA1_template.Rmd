...
```{r}
activity <- read.csv("C:/Users/Administrator/Desktop/DS/Reproducible Research/activity.csv", colClasses = c("numeric", "character", 
    "numeric"))
head(activity)
...
Here we will first use an aggregate function
```{r}
